...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	int temp = atoi(password_chr);
	for(uint8_t i = 0; i < strlen(password_chr); i++)
	{
		password_int = password_int + temp % 10;
		temp = temp / 10;
	}
    ...
    /* USER CODE BEGIN 3 */
		...
		switch (state_system)
		{
			...
			case 0:
				...
				// If read and correct, change to state system 1
			...
			case 1:
				...
				// If correct, change to state system 3	
